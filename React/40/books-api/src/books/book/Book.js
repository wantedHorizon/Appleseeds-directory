        ...
        return (
            ...
            <div className="item book" style={{ border: '1px solid black', borderRadius: '10px', padding: '5px 10px', background: '#e5e5e5' }}>
                ...
                <div className="image" >
                    ...
                    <input
                        onChange={(e) => this.props.methods.change(e, data.id)}
                        type="text" data-state="image" value={data.image}
                        name="imgUrl"
                ...
                <div className="content">
                    {this.state.edit ? <input onChange={(e) => this.props.methods.change(e, data.id)}
                        data-state="name"
                        type="text"
                        name="nameInput"
                        value={data.name}
                    ...
                    <div className="description">
                        ...
                        <input onChange={(e) => this.props.methods.change(e, data.id)}
